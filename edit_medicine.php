<?php
    ...
    if(isset($_POST['upload'])){
        ...
        mysqli_query($conn,"UPDATE medicine SET name='$name', g_name='$g_name',properties='$properties' WHERE id='$id'");
        echo "";
    ...
    if(isset($_POST['edit'])){
        $id =$_POST['id'];
        $resultt =mysqli_query($conn,"SELECT * FROM medicine WHERE id= '".$_POST['id']."'   ");
    ...
    <div class="sidebar">
        ...
        <section id="upload_container">
            ...
            <input type="hidden" name="id" id="id"  value="<?php echo $row['id'] ;   ?>">
                ...
                <input type="text" name="g_name" id="g_name"value="<?php echo $row['g_name'] ;   ?>" >
