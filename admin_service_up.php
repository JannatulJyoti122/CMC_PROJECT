...
if (isset($_POST['upload'])) {
	...
	$sql = "INSERT INTO service (name,properties,image) VALUES ('$name','$properties','$filename')";
    ...
    <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li><a href="admin_service.php"><span class="las la-igloo"></span>
                        <span>back</span></a>
        ...
        <section id="upload_container">
            <form action="" method="POST" enctype="multipart/form-data" >
                <input type="text" name="name" id="name" placeholder="Enter Service" required>
                <input type="text" name="properties" id="properties"placeholder="Enter Service Properties"required >
