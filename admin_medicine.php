    ...
    <body>
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                <li><a href="admin_medicine_up.php"><span class="las la-igloo"></span>
                        <span>Add New Medicine</span></a>
        ...
        <div class="main-content">
            ...
            <main>
                ...
                <div class="card">
                    <div class ="image">
                        <img src="./medicine/<?php echo $row['image']; ?>" alt="">
                    </div>
                    <div calss ="caption">
                        <p class="Name">Name:<?php echo $row["name"];?></pp>
                        <p class="Name">Generic Name:<?php echo $row["g_name"];?></p>
                        <p class="Name">Properties:<?php echo $row["properties"];?></p>
