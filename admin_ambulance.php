    ...
    <body>
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                <li><a href="admin_ambulance_up.php"><span class="las la-igloo"></span>
                        <span>Add New Ambulance</span></a>
        ...
        <div class="main-content">
            ...
            <main>
                ...
                <div class="card">
                    <div class ="image">
                        <img src="./ambulance/<?php echo $row['image']; ?>" alt="">
                    </div>
                    <div calss ="caption">
                        <p class="name">Name of Driver:<?php echo $row["name"];?></pp>
                        <p class="phone">Driver Phone:<?php echo $row["phone"];?></p>
                        <p class="number">Ambulance Number:<?php echo $row["number"];?></p>
                        <p class="schedule">schedule:<?php echo $row["schedule"];?></p>
                        <form action="edit_ambulance.php" method ="POST">
                            <input type="hidden"name="id" value="<?php  echo $row['id']    ?>">
                            <input type="submit" name="edit" class="edit"value="EDIT"></input>
                        </form>
                        <form action="delete_ambulance.php" method ="POST">
                            <input type="hidden"name="id" value="<?php  echo $row['id']    ?>">
